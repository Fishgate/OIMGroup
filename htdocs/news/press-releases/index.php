        ...
        <div id='contentwrap' class='clearfix'>
            <div id='body' class='left'>
                ...
                <div class="news-holder dotted-bottom clearfix">
                    ...
                    <div class="left news-article">
                        <article class="clearfix">
                            <header class="news-head">Do SA businesses have a capacity problem</header>
                            ...
                            <div class="left news-readmore"><i class="icon-angle-right icon-large"></i>&nbsp;<a href="news_article_capacity_problem_press.php">Read More</a></div>
                            <div class="right">Posted in <a href="index.php">Press Releases</a></div>
                        </article>
                    </div>
                </div>
                ...
                <div class="news-holder dotted-bottom clearfix">
                    ...
                    <div class="left news-article">
                        <article class="clearfix">
                            ...
                            <div class="left news-readmore"><i class="icon-angle-right icon-large"></i>&nbsp;<a href="news_article_improved_efficiency_press.php">Read More</a></div>
                            <div class="right">Posted in <a href="index.php">Press Releases</a></div>
                        </article>
                    </div>
                </div>
...
My job is all about problem solving and ultimately adding value to a client’s business. On a day-to-day basis I engage with clients to identify operational improvement opportunities for revenue upliftment and cost reduction...</p>
                            <div class="left news-readmore"><i class="icon-angle-right icon-large"></i>&nbsp;<a href="news_article_cape_argus_press.php">Read More</a></div>
                            <div class="right">Posted in <a href="index.php">Press Releases</a></div>
                        </article>
                    </div>
                </div>
                ...
                <div class="news-holder dotted-bottom clearfix">
                    ...
                    <div class="left news-article">
                        <article class="clearfix">
                            ...
                            <div class="left news-readmore"><i class="icon-angle-right icon-large"></i>&nbsp;<a href="news_article_hlengiwe_skosana_press.php">Read More</a></div>
                            <div class="right">Posted in <a href="index.php">Press Releases</a></div>
                        </article>
                    </div>
                </div>
                ...
                <div class="news-holder dotted-bottom clearfix">
                    ...
                    <div class="left news-article">
                        <article class="clearfix">
                            ...
                            <div class="left news-readmore"><i class="icon-angle-right icon-large"></i>&nbsp;<a href="news_article_frans_germishuizen_press.php">Read More</a></div>
                            <div class="right">Posted in <a href="index.php">Press Releases</a></div>
                        </article>
                    </div>
                </div>
