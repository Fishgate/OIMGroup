    ...
    <body>
        ...
        <div id='contentwrap' class='clearfix'>
            <div id='body' class='left'>
                <div class='breadcrumb'><i class="icon-map-marker icon-large red"></i> &nbsp;YOU ARE HERE: <a href='#'>News</a> / <span class='red'>Press Releases -Page 2</span></div>
                ...
                <div class="clearfix">
                    <ul class="right paginate">
                        <li><a href="news_cat_press.php">1</a></li>
                        <li>2</li>
                    </ul>
                </div>
            </div>
