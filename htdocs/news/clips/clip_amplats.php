    ...
    <body>
        ...
        <div id='contentwrap' class='clearfix'>
            <div id='body' class='left'>
                <div class='breadcrumb'><i class="icon-map-marker icon-large red"></i> &nbsp;YOU ARE HERE: <a href='../'>News</a> / <a href='index.php'>Clips</a> / <span class='red'>Amplats reaches agreement with Amcu</span></div>
                <h1>Clips</h1>
                <!--==================================== NEWS ARTICLE =====-->
