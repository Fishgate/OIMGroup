    ...
    <body>
        ...
        <div id='contentwrap' class='clearfix'>
            <div id='body' class='left'>
                <div class='breadcrumb'><i class="icon-map-marker icon-large red"></i> &nbsp;YOU ARE HERE: <a href='index.php'>News</a> / <a href='news_archive_2013.php'>Archive</a> / <span class='red'>2013 -page 2</span></div>
                <h1>Archive - 2013</h1>
                <!--==================================== NEWS ARTICLE =====-->
                <div class="news-holder dotted-bottom clearfix">
                    ...
                    <div class="left news-article">
                        <article class="clearfix">
                            ...
                            <div class="left news-readmore"><i class="icon-angle-right icon-large"></i>&nbsp;<a href="../press-releases/news_article_jaco_vdmerwe_press.php">Read More</a></div>
                ...
                <div class="news-holder dotted-bottom clearfix">
                    ...
                    <div class="left news-article">
                        <article class="clearfix">
                            ...
                            <p>Kevin Setzkorn has recently been appointed as Operation Solutions Consultant at OIM, one of South Africa’s leading business performance specialists. Setzkorn will be consulting on supervisory development projects at the company as well as providing on-the-floor coaching to supervisors.</p>
                            <div class="left news-readmore"><i class="icon-angle-right icon-large"></i>&nbsp;<a href="../press-releases/news_article_kevin_setzkorn_press.php">Read More</a></div>
                            <div class="right">Posted in <a href="../press-releases/index.php">Press Releases</a></div>
                        </article>
                    </div>
                </div>
                ...
                <div class="news-holder dotted-bottom clearfix">
                    ...
                    <div class="left news-article">
                        <article class="clearfix">
                            ...
                            <div class="left news-readmore"><i class="icon-angle-right icon-large"></i>&nbsp;<a href="../press-releases/news_article_mamphela_ramphele_press.php">Read More</a></div>
                            <div class="right">Posted in <a href="../press-releases/index.php">Press Releases</a></div>
                        </article>
                    </div>
                </div>
                ...
                <div class="clearfix">
                    <ul class="right paginate">
                        <li><a href="index_2013.php">1</a></li>
                        <li>2</li>
                    </ul>
                </div>
            </div>
