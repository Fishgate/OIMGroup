...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Social Development | Corporate Social Investment - CSI | OIM</title>
        <meta name="description" content="OIM focuses on social development and contributes to the community with their non-profit organisation, The Trust for Peace and Prosperity">
    ...
    <body>
        ...
        <div id='contentwrap' class='clearfix'>
            <div id='body' class='left'>
                <div class='breadcrumb'><i class="icon-map-marker icon-large red"></i> &nbsp;YOU ARE HERE: <a href='index.php'>About OIM</a> / <span class='red'>CSI</span></div>
                <h1>CSI</h1>
                <div class='copy'>
                    <p>OIM’s history is deeply rooted in social development. Through our non-profit organisation, The Trust for Peace and Prosperity, OIM has been investing in socio-economic development since 1983 – long before it became part of BEE scorecards and legislation. The Trust, which originated from a group of non-profit organisations first registered in 1974, was in many ways the forerunner of OIM’s commercial enterprises.</p> 

                    <p>Today OIM still focuses on social development as part of our commitment to make a meaningful contribution to the long-term prosperity of our client organisations, as well as the individuals and communities we interact with.</p> 
                    ...
                    <p><strong>Basic education in Wallacedene</strong><br/>
                    ...
                    <p><strong>Conflict resolution in numerous mining communities</strong><br/>
                    ...
                    <p><strong>Business interventions in the fishing industry, West Coast</strong><br/>
                    ...
                    <p><strong>Workshops in business principles, North West </strong><br/>
                    ...
                    <p><strong>Diversity management in the education sector, Polokwane</strong><br/>
                    ...
                    <p><strong>Ad hoc educational sponsorships</strong><br/>
