...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Business Consultants | Business Ethos | OIM</title>
        <meta name="description" content="OIM are business consultants with a business ethos of service delivery commitment and business solutions for performance management systems">
    ...
    <body>
        ...
        <div id='contentwrap' class='clearfix'>
            <div id='body' class='left'>
                <div class='breadcrumb'><i class="icon-map-marker icon-large red"></i> &nbsp;YOU ARE HERE: <a href='index.php'>About OIM</a> / <span class='red'>Business Ethos</span></div>
                <h1>Business Ethos</h1>
                <div class='copy'>
                    <p><strong>OIM strives to be a credible and acknowledged partner delivering value and growth.</strong></p>

                    <p>Our aim is to make a meaningful contribution to the long-term prosperity of our clients, consultants and employees and to make a difference in the lives of the individuals and communities we engage with every day. Our main areas of competence are consultation, facilitation and training.</p>

                    <h2>Our service philosophy</h2>
                    <p><strong>What clients can expect from OIM</strong></p>
                    <ul>
                        ...
                        <li>We are committed to making a long-term contribution to our clients’ business performance. As such, we understand our role will change over time from, for instance, initially assisting with the facilitation and implementation of the intervention to eventually providing ongoing support and information updates.</li>
