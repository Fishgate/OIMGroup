...
<?php switch ($pagetype) {
    ...
    case "about": ?><div class="rslides" style="height: 370px; overflow: hidden;"><li><div class="calltoaction"><span class="quote">The ones who keep improving<br/> are the ones who stay relevant</span></div><div class="calltoaction_mini_max"><span class="quote_mini">Analyse. Improve. Sustain</span></div><img src="<?php echo $relpath; ?>img/concept_photos/about.jpg" alt=""></li></div><?php break;
    case "clients": ?><div class="rslides" style="height: 370px; overflow: hidden;"><li><div class="calltoaction"><span class="quote text_right">The ones who keep improving<br/> are the ones who stay relevant</span></div><div class="calltoaction_mini_max"><span class="quote_mini">Analyse. Improve. Sustain</span></div><img src="<?php echo $relpath; ?>img/concept_photos/clients.jpg" alt=""></li></div><?php break;
    case "team": ?><div class="rslides" style="height: 370px; overflow: hidden;"><li><div class="calltoaction"><span class="quote">Without an experienced team to<br/> facilitate improvement,<br/> market leaders become followers</span></div><div class="calltoaction_mini_max"><span class="quote_mini">Analyse. Improve. Sustain</span></div><img src="<?php echo $relpath; ?>img/concept_photos/team.jpg" alt=""></li></div><?php break;
    ...
    case "news": ?><div class="rslides" style="height: 370px; overflow: hidden;"><li><div class="calltoaction"><span class="quote">Staying on top means<br/> staying on top of what's happening</span></div><div class="calltoaction_mini_max"><span class="quote_mini">Analyse. Improve. Sustain</span></div><img src="<?php echo $relpath; ?>img/concept_photos/news.jpg" alt=""></li></div><?php break;
    ...
    case "careers": ?><div class="rslides" style="height: 370px; overflow: hidden;"><li><div class="calltoaction"><span class="quote text_right">The ones who keep improving<br/> are the ones who stay relevant</span></div><div class="calltoaction_mini_max"><span class="quote_mini">Analyse. Improve. Sustain</span></div><img src="<?php echo $relpath; ?>img/concept_photos/careers.jpg" alt=""></li></div><?php break;
    case "partnerships": ?><div class="rslides" style="height: 370px; overflow: hidden;"><li><div class="calltoaction"><span class="quote">Without an experienced team to<br/> facilitate improvement,<br/> market leaders become followers</span></div><div class="calltoaction_mini_max"><span class="quote_mini">Analyse. Improve. Sustain</span></div><img src="<?php echo $relpath; ?>img/concept_photos/partnerships.jpg" alt=""></li></div><?php break;
    ...
    case "methodology": ?><div class="rslides" style="height: 370px; overflow: hidden;"><li><div class="calltoaction"><span class="quote text_right">Progress comes as a result<br/> of proven methodologies</span></div><div class="calltoaction_mini_max"><span class="quote_mini">Analyse. Improve. Sustain</span></div><img src="<?php echo $relpath; ?>img/concept_photos/methodology.jpg" alt=""></li></div><?php break;
    ...
    <div style="height: 370px; overflow: hidden;">
        <ul class="rslides" id="slider1" style="margin: 0 auto;">
          ...
          <li>
              ...
              <img src="<?php echo $relpath; ?>img/concept_photos/partnerships.jpg" alt="">
              <div class="calltoaction_mini_max"><span class="quote_mini">Analyse. Improve. Sustain</span></div>
          </li>
        </ul>
    </div>
