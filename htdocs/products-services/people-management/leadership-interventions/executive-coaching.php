...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Executive Coaching - Business Coach | OIM</title>
        <meta name="description" content="OIM's offers executive coaching in career-transitioning coaching, performance improvement coaching and leadership coaching">
    ...
    <body>
        ...
        <div id='contentwrap' class='clearfix'>
            <div id='body' class='left'>
                ...
                <h1>Coaching</h1>
                <div class='caption'><span>Improve performance time and again</span></div>
                <div class='copy'>
