<?php $relpath = "../../../"; ?>
<?php $pagetype = "reward_consulting"; ?>
...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Reward Consulting - Reward Consultant | OIM</title>
        <meta name="description" content="OIM's reward consulting helps organisations to develop an effective reward strategy to attract, motivate and retain key employees">
