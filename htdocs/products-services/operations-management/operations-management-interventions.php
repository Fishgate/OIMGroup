...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Operations Management Interventions | OIM</title>
        <meta name="description" content="Improve business processes and resolve operational constraints with OIM's operations management interventions">
            ...
            <div id='body' class='left'>
                ...
                <div class='copy'>
                    ...
                    <p><strong>The result is:</strong>
                        <ul>
                            <li>A visible improvement in quality,</li> 
                            <li>Reduced unit costs,</li> 
                            <li>Increased operational compliance and control, and</li> 
                    ...
                    <p><strong>Operations audit</strong> (business/operations review)<br/>
                    A quick and reliable way to identify areas of operational constraint and map a solution. <a href='<?php echo $relpath; ?>products-services/operations-management/operations-management.php'>Read more</a>
                    </p>
                    
                    <p><strong>Business process analysis and process re-engineering</strong><br/>
                    An in-depth analysis and redesign of workflows and business processes.
                    </p>
                    
                    <p><strong>Maintenance optimisation</strong><br/>
                    ...
                    <p>
                        <ul>
                            ...
                            <li><strong>Maintenance optimisation</strong><br/>
                            A focus on the optimal forecasting, scheduling and execution of planned work. </li>
