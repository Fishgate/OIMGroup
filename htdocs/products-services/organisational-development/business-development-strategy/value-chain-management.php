<?php $relpath = "../../../"; ?>
<?php $pagetype = "value_chain_optimisation"; ?>
...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Value Chain Management - Value Chain Optimisation | OIM</title>
        <meta name="description" content="OIM offers a comprehensive approach to value chain management with industry-specific solutions to optimise business processes with value chain optimisation">
