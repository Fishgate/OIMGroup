<?php $relpath = "../../"; ?>
<?php $pagetype = "employee_relations"; ?>
            ...
            <div id='body' class='left'>
                ...
                <div class='copy'>
                    ...
                    <ul>
                        ...
                        With a track record dating back to 1985, OIM has developed a proven approach to conflict resolution and gained experience in tailoring the approach to various situations.</li>  
                    </ul>
                    ...
                    <p>
                        <ul>
                            <li>OIM offers an integrated solution, targeting all key employee relations areas and focusing on both legal and human aspects.</li> 
                            <li>This comprehensive strategy is aligned to your business goals and integrates all employee relations practices.</li>
                            ...
                            <li>If required, clients also benefit from the expertise embedded in all OIM’s core business areas, namely people management, operational optimisation and organisational performance improvement. Other services include strategic planning, business process management, leadership development and individual performance management.</li>
                        </ul>
                    <p>
                </div>
            </div>
