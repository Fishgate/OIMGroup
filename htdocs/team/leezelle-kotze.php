...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Leadership Team - Leezelle Kotze | OIM</title>
        <meta name="description" content="Leezelle Kotze, a registered industrial psychologist, is the MD of Leadership Talent at OIM  and has expertise in the areas of talent management and leadership">
        ...
        <div id='contentwrap' class='clearfix'>
            <div id='body' class='left'>
                ...
                <div class='copy'>
                    ...
                    <p>She rejoined OIM in 2013, this time as managing director of the Leadership Talent division which focuses on a range of offerings that help organisations to define, assess, develop and manage their leadership talent in an integrated way.</p>
                    ...
                    <ul>
                        <li>Insights&reg;</li>
                        <li>Career Path Appreciation (CPA) (Bioss)</li>
                        <li>IRIS Trained (2003) (Bioss)</li>
                        <li>MBTI Step I and II (Jopie van Rooyen)</li>
                        <li>OPQ (SHL)</li>
                        <li>15FQ+ (Psytech)</li>
                        <li>Cognitive assessments (Psytech, SHL)</li>
                        <li>WPS (SHL)</li>
                    </ul>
                    
                    <h2>On A Personal Note</h2>
                    <p>When Leez&eacute;lle is not having tea parties with her toddler daughter she enjoys waterskiing and taking her off-road motorcycle for a spin. But when she really wants to get away from it all she, her husband and daughter head for a remote camping site where there is no cellphone reception.</p>
                </div>
            </div>
