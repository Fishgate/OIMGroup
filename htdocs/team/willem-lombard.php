...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Leadership Team - Willem Lombard | OIM</title>
        <meta name="description" content="Willem Lombard is the senior consultant of performance improvement at OIM  and has consulted in  many sectors such as construction and finance and banking">
    ...
    <body>
        ...
        <div id='contentwrap' class='clearfix'>
            <div id='body' class='left'>
                ...
                <div class='copy'>
                    <img class="response-img" src="<?php echo $relpath; ?>/img/team/willem_large.jpg" />
