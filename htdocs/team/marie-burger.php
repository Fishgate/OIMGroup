...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Leadership Team - Marie Burger | OIM</title>
        <meta name="description" content="Marie Burger is the chartered accountant and financial director of OIM and has played a crucial rule in the restructuring of the finance function">
    ...
    <body>
        ...
        <div id='contentwrap' class='clearfix'>
            <div id='body' class='left'>
                ...
                <div class='copy'>
                    <img src="<?php echo $relpath; ?>/img/team/marie_large.jpg" />
