...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Leadership Team - Fred Arendse | OIM</title>
        <meta name="description" content="Fred Arendse is the non-executive director as OIM and joined the organisation in 2005 and has more than 13 years' experience in the mining industry">
    ...
    <body>
        ...
        <div id='contentwrap' class='clearfix'>
            <div id='body' class='left'>
                ...
                <div class='copy'>
                    <img src="<?php echo $relpath; ?>/img/team/fred_large.jpg" />
